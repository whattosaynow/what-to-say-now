...
INSERT INTO "public"."content"("id", "role_id", "ageGroup_id", "week", "intro") VALUES(3, 1, 2, 1, '“Healthy, athletic bodies come in all shapes and sizes."') RETURNING "id", "role_id", "ageGroup_id", "week", "intro", "why_matters", "reflection", "action_steps";
...
INSERT INTO "public"."content"("id", "role_id", "ageGroup_id", "week") VALUES(5, 1, 2, 2) RETURNING "id", "role_id", "ageGroup_id", "week", "intro", "why_matters", "reflection", "action_steps";
